...
/*      console.log(evt);
      ...
      facebookShareUrl(response.id, message);*/
    }, false);
...
function shareToFacebook() {
  ...
  //var canvas = $('#canvas')[0];  // FOR SUBMISSION - SWITCH WITH LAST LINE
  ...
  FB.getLoginStatus(function(response) {
    ...
    postImageToFacebook(response.authResponse.accessToken, "meme-generator.png", "image/png", decodedPng, message);
...
function shareToTwitter() {
  ...
  var formdata = twitterFormData("meme-generator.png", "image/png", encodedPng /* decodedPng */, message);
